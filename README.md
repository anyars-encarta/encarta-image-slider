...
<div align="center">
 ...
 <!-- LOGO -->
  ...
  <img src="./src/assets/image-slider.JPG" alt="logo" width="160"  height="auto" />
  <br/>

<!-- MAIN HEADING -->

  <h3><b>Encarta Image Slider</b></h3>
...
> - Jump to specific images by clicking the indicator circles beneath the image
...
> 
```sh
cd encarta-image-slider
https://github.com/anyars-encarta/encarta-image-slider.git
```
